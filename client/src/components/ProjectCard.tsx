...
const skillStyle = "bg-[#F2F2F2] dark:bg-[#292929] dark:text-white p-1 rounded-full text-sm px-3 hover:scale-105 transition-transform duration-200"


const ProjectCard = () => {
  return (
    <div className="text-justify bg-white dark:bg-[#171717] rounded-2xl mx-auto my-2 px-5 pt-3 pb-8">
        ...
        <div className="flex gap-6">
            ...
            <div className="flex-col gap-2">
                <p className="text-xl dark:text-white font-medium mb-1">Grocery Scout</p>
                <div className="flex gap-2">
                    <a href="https://grocery-scout.com/" target="blank">
                        <button className="text-white dark:bg-white dark:text-black bg-[#171717] p-2 rounded-xl hover:opacity-80">Website</button>
                    </a>
                    <a href="https://github.com/osamaaabdullah/Grocery-Scout" target="blank">
                        <button className="text-white dark:bg-white dark:text-black bg-[#171717] p-2 rounded-xl hover:opacity-80">GitHub</button>
                    </a>
                </div>
            </div>
